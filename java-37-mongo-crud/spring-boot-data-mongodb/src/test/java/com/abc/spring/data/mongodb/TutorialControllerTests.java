...
import com.abc.spring.data.mongodb.controller.TutorialController;
...
public class TutorialControllerTests {
  ...
  //  @MockBean
    ...
    void shouldCreateTutorial() throws Exception {
        Tutorial tutorial = new Tutorial("6767da3c96e4b7221a906b2e", "Celalettin", "Aksoy", false);
    ...
    void shouldReturnTutorial() throws Exception {
        String id = "6767db7396e4b7221a906b31";
    ...
    void shouldReturnNotFoundTutorial() throws Exception {
        String id = "6767da3c96e4b7221a906b2e";
    ...
    void shouldReturnListOfTutorials() throws Exception {
        List<Tutorial> tutorials = new ArrayList<>(
                Arrays.asList(new Tutorial("6767da3c96e4b7221a906b2e", "Celalettin", "Aksoy", false),
                        new Tutorial("6767da7996e4b7221a906b30", "Spring Boot @WebMvcTest 2", "Description 2", true),
                        new Tutorial("6767db7396e4b7221a906b31", "Spring Boot @WebMvcTest 3", "Description 3", true)));
    ...
    void shouldDeleteTutorial() throws Exception {
        String id = "6767da6b96e4b7221a906b2f";
